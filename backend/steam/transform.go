...
// converts Steam API game details to our database model
...
// converts Steam categories/genres to our GameTag models
func SteamTagsToGameTags(steamGame *SteamGameDetails, gameID uint) []models.GameTag {
